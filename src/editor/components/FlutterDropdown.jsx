...
export default function FlutterDropdown({ id }) {
  ...
  const items = widget.items || ['Opción 1', 'Opción 2', 'Opción 3']
  const selected = widget.value ?? items[0]

  const handleChange = (e) => {
    updateWidget(id, { value: e.target.value })
  }
